...
rotation_set = ['{}','1{0,10}','{}','{}'] #PHI
#rotation_set = ['{}','{}','1{0,10}','{}'] #PSI
#rotation_set = ['{}','{}','{}','1{0,10}'] #OMEGA
#rotation_set = ['{}','{}','{}','{}']
# Residue 1
dic_atoms['branch'].extend(['1','1','1','1'])
dic_atoms['position'].extend(['1','2','3','3'])
...
# Residue 2
dic_atoms['branch'].extend(['1','1','1','1'])
dic_atoms['position'].extend(['4','5','6','6'])
...
# Residue 3
dic_atoms['branch'].extend(['1','1','1','1'])
dic_atoms['position'].extend(['7','8','9','9'])
...
atoms_maker = syn.AtomCollection(atoms_data,log=1 )
print(atoms_maker)
atoms_df = atoms_maker.makeRandomVersions(500)
print(atoms_df)

geo_mak = gm.GeometryMaker([],init_biopython=False,atoms_data=atoms_df)
df = geo_mak.calculateGeometry(['N:CA:C:N+1','N:O','C-1:N:CA:C','N:CA','CA:C','C:O','C:N+1','CA:C:N+1:CA+1','CA-1:C-1:N:CA','N:N+1'])
print(df)

rep_mak = hm.HtmlReportMaker('Synthetic Geometry','Html/AO_SyntheticRandom.html', cols=4)
...
rep_mak.addPlot1d(df, 'histogram', 'CA-1:C-1:N:CA', hue='pdb_code', title='OMEGA-1')
