...
ID = 'Correlation_TAUp1'
tag = ''
csv = 'PW_High_02_Geometry.csv'
geoA = 'CA:C:N+1'
outlier_cut = 25
#start_count,end_count = 1,40 #inclusive
start_count,end_count = 41,80 #inclusive
#start_count,end_count = 81,126 #inclusive
aa = ''
exclude_aa = ['PRO']
override_geos = []#['CB:CA:C:N+1','N:CA:C:N+1','CB:CA:C:O','O:CB','N+1:O+1','N:N+1','N:CB-1']
hue = 'aa'
